...
import SideNavigate from "@/components/SideNavigate.vue";
...
//刷新头部
const isHeaderAlive = ref(true)

const route = reactive(useRoute())
const router = useRouter()
const token = ref<sessionType>(sessionStorage.getItem("token"))
const nickName = ref<sessionType>(sessionStorage.getItem("nickName"))
//DOM更新
