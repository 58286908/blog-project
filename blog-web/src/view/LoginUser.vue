 ...
 * @LastEditTime: 2023-04-18 16:59:31
    ...
    <div class="mylogin" align="center">
      ...
      <el-form :model="loginForm" :rules="loginRules" label-width="0px">
        ...
        <el-form-item style="margin-top: 55px">
          <el-button type="primary" round class="submitBtn" @click="handlerLogin">登录
          </el-button>
        </el-form-item>
      </el-form>
    </div>
  ...
  setup () {
    ...
    const handlerLogin = (() => {
      login(loginForm).then(res => {
        ...
        res.data.code === 200 ? sessionStorage.setItem("token", res.data.data.Authorization) : sessionStorage.setItem("token", '')
        res.data.code === 200 ? sessionStorage.setItem("nickName", res.data.data.nickName) : sessionStorage.setItem("nickName", '')
        res.data.code === 200 ? router.push('/') : this.$msgError("123")
      })
    })
